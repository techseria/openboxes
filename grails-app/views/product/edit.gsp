...
<head>
    ...
    <link rel="stylesheet" href="${createLinkTo(dir:'js/inputtag/',file:'bootstrap-tagsinput.css')}" type="text/css" media="screen, projection" />
    <script src="${createLinkTo(dir:'js/inputtag/', file:'bootstrap-tagsinput.js')}" type="text/javascript" ></script>
