...
class PartialReceivingPage extends Component {
  ...
  exportTemplate() {
    ...
    const url = `${process.env.REACT_APP_BASE_NAME}/api/partialReceiving/exportCsv/${shipmentId}`;
  ...
  importTemplate(event) {
    ...
    const url = `${process.env.REACT_APP_BASE_NAME}/api/partialReceiving/importCsv/${this.props.formValues.shipmentId}`;
