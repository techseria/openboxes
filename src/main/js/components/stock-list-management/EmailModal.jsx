...
class EmailModal extends Component {
  ...
  onSave(values) {
    ...
    const url = `${process.env.REACT_APP_BASE_NAME}/api/stocklists/sendMail/${this.props.stocklistId}?includePdf=${this.state.formValues.includePdf}?includeXls=${this.state.formValues.includeXls}`;
    const payload = {
      ...values,
