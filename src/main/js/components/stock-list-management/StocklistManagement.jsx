...
class StocklistManagement extends Component {
  ...
  fetchData() {
    this.props.showSpinner();
    const url = `${process.env.REACT_APP_BASE_NAME}/api/stocklistItems?product.id=${this.props.match.params.productId || ''}`;
  ...
  fetchAvailableStocklists() {
    this.props.showSpinner();
    const url = `${process.env.REACT_APP_BASE_NAME}/api/stocklistItems/availableStocklists`;
  ...
  fetchProductInfo() {
    this.props.showSpinner();
    const url = `${process.env.REACT_APP_BASE_NAME}/api/products/${this.props.match.params.productId}/withCatalogs`;
  ...
  saveItem(index, item) {
    let url = `${process.env.REACT_APP_BASE_NAME}/api/stocklistItems?product.id=${this.props.match.params.productId || ''}`;

    if (!item.new) {
      url = `${process.env.REACT_APP_BASE_NAME}/api/stocklistItems/${item.requisitionItem.id}`;
    }
  ...
  deleteItem(index) {
    ...
    if (item.new) {
      ...
      this.props.showSpinner();
      const url = `${process.env.REACT_APP_BASE_NAME}/api/stocklistItems/${item.requisitionItem.id}`;
          ...
          <div className="d-flex flex-row justify-content-between">
            ...
            <div className="align-self-center">
              <button
                ...
                onClick={() => { window.location = `${process.env.REACT_APP_BASE_NAME}/inventoryItem/showStockCard/${this.state.productInfo.id}`; }}
  ...
  ><Translate id="react.stockListManagement.stockListName.label" defaultMessage="Stocklist Name" />
              ...
              Cell: ({ aggregated, original }) => {
                ...
                return (
                  <a href={`${process.env.REACT_APP_BASE_NAME}/requisitionTemplate/show/${original.stocklistId}`}>
                    <Tooltip
                      title={original.name}
                      theme="transparent"
                      delay="150"
                ...
                return (
                  <div className="d-flex flex-wrap">
                    ...
                    <a
                      ...
                      href={`${process.env.REACT_APP_BASE_NAME}/stocklist/renderPdf/${original.stocklistId}`}
                    ><Translate id="react.default.button.printPdf.label" defaultMessage="Print PDF" />
                    </a>
                    <a
                      className="btn btn-outline-secondary btn-xs mr-1"
                      disabled={original.edit || original.new}
                      href={`${process.env.REACT_APP_BASE_NAME}/stocklist/generateCsv/${original.stocklistId}`}
