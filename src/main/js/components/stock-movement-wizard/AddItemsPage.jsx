...
class AddItemsPage extends Component {
   ...
   */
  fetchLineItems() {
    const url = `${process.env.REACT_APP_BASE_NAME}/api/stockMovements/${this.state.values.stockMovementId}?stepNumber=2`;
  ...
  saveRequisitionItems(lineItems) {
    ...
    const updateItemsUrl = `${process.env.REACT_APP_BASE_NAME}/api/stockMovements/${this.state.values.stockMovementId}/updateItems`;
    const payload = {
   ...
   */
  removeItem(itemId) {
    const removeItemsUrl = `${process.env.REACT_APP_BASE_NAME}/api/stockMovementItems/${itemId}/removeItem`;
   ...
   */
  removeAll() {
    const removeItemsUrl = `${process.env.REACT_APP_BASE_NAME}/api/stockMovements/${this.state.values.stockMovementId}/removeAllItems`;
  ...
  saveItemsAndExportTemplate(formValues, lineItems) {
    ...
    const url = `${process.env.REACT_APP_BASE_NAME}/stockMovement/exportCsv/${stockMovementId}`;
    this.saveRequisitionItemsInCurrentStep(lineItems)
      .then(() => {
  ...
  importTemplate(event) {
    ...
    const url = `${process.env.REACT_APP_BASE_NAME}/stockMovement/importCsv/${stockMovementId}`;
