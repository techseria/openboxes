...
class PickPage extends Component {
   ...
   */
  fetchPickPageData() {
    const url = `${process.env.REACT_APP_BASE_NAME}/api/stockMovements/${this.state.values.stockMovementId}?stepNumber=4`;
  ...
  fetchAdjustedItems(adjustedProductCode) {
    apiClient.post(`${process.env.REACT_APP_BASE_NAME}/api/stockMovements/${this.state.values.stockMovementId}/updateAdjustedItems?adjustedProduct=${adjustedProductCode}`)
      .then((resp) => {
        const { pickPageItems } = resp.data.data.pickPage;
   ...
   */
  fetchBins() {
    const url = `${process.env.REACT_APP_BASE_NAME}/api/internalLocations?location.id=${this.state.values.origin.id}`;
  ...
  revertUserPick(itemId) {
    ...
    const itemsUrl = `${process.env.REACT_APP_BASE_NAME}/api/stockMovementItems/${itemId}/createPicklist`;
  ...
  exportTemplate(formValues) {
    ...
    const url = `${process.env.REACT_APP_BASE_NAME}/api/stockMovements/exportPickListItems/${stockMovementId}`;
  ...
  importTemplate(event) {
    ...
    const url = `${process.env.REACT_APP_BASE_NAME}/api/stockMovements/importPickListItems/${stockMovementId}`;
